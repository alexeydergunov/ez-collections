...
import ez.collections.sort._Ez_Int_ReverseSort;

import java.util.Collection;
import java.util.NoSuchElementException;

public class _Ez_Int_MaxHeap implements _Ez_Int_PriorityQueue {
    ...
    public _Ez_Int_MaxHeap() {
        this(DEFAULT_CAPACITY);
    }

    public _Ez_Int_MaxHeap(int capacity) {
        if (capacity < 0) {
    ...
    public _Ez_Int_MaxHeap(_Ez_Int_Collection collection) {
    ...
    public _Ez_Int_MaxHeap(/*C*/int/*C*/[] srcArray) {
    ...
    public _Ez_Int_MaxHeap(Collection</*WC*/Integer/*WC*/> javaCollection) {
    ...
    public /*C*/int/*C*/ removeFirst() {
        ...
        final /*C*/int/*C*/ maximalElement = heap[0];
        heap[0] = heap[--size];
        down(0);
    ...
    public boolean equals(Object o) {
        ...
        _Ez_Int_MaxHeap that = (_Ez_Int_MaxHeap) o;
        ...
        _Ez_Int_ReverseSort.sort(thisArray);
        _Ez_Int_ReverseSort.sort(thatArray);
        for (int i = 0; i < size; i++) {
