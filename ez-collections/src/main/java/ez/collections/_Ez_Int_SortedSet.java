...
public interface _Ez_Int_SortedSet extends _Ez_Int_Set {
     ...
     * {@link #floor}, {@link #ceiling}, {@link #lower} or {@link #higher} has returned the correct value.
     * <p>
     * In other words, this method returns {@code false} if and only if the set from the Java Collections Library
     * ({@link java.util.NavigableSet}) which contains the same elements returns {@code null} after calling the same
     * method.
     * @return {@code true} if the last call of one of the methods listed above has returned the correct value,
