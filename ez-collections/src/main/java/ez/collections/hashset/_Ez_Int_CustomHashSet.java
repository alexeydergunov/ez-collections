...
public class _Ez_Int_CustomHashSet implements _Ez_Int_Set {
    ...
    private final _Ez_Int_Hasher hasher;

    public _Ez_Int_CustomHashSet() {
        this(DEFAULT_CAPACITY, _Ez_Int_Hasher.DEFAULT);
    }

    public _Ez_Int_CustomHashSet(int capacity) {
        this(capacity, _Ez_Int_Hasher.DEFAULT);
    }

    public _Ez_Int_CustomHashSet(_Ez_Int_Hasher hasher) {
        this(DEFAULT_CAPACITY, hasher);
    }

    public _Ez_Int_CustomHashSet(int capacity, _Ez_Int_Hasher hasher) {
        if (capacity < 0) {
    ...
    public _Ez_Int_CustomHashSet(_Ez_Int_Collection collection) {
    ...
    public _Ez_Int_CustomHashSet(/*T*/int/*T*/[] srcArray) {
    ...
    public _Ez_Int_CustomHashSet(Collection</*W*/Integer/*W*/> javaCollection) {
    ...
    public boolean contains(/*T*/int/*T*/ element) {
        final int elementHash = hasher.getHash(element);
    ...
    public boolean equals(Object o) {
        ...
        _Ez_Int_CustomHashSet that = (_Ez_Int_CustomHashSet) o;
