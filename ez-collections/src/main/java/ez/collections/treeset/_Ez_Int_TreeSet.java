...
public class _Ez_Int_TreeSet implements _Ez_Int_SortedSet {
    ...
    public _Ez_Int_TreeSet() {
        this(DEFAULT_CAPACITY);
    }

    public _Ez_Int_TreeSet(int capacity) {
        if (capacity < 0) {
    ...
    public _Ez_Int_TreeSet(_Ez_Int_Collection collection) {
    ...
    public _Ez_Int_TreeSet(/*C*/int/*C*/[] srcArray) {
    ...
    public _Ez_Int_TreeSet(Collection</*WC*/Integer/*WC*/> javaCollection) {
